...
export const LoginPage = () => {
    ...
    const handleLogin = async (code: string) => {
        ...
        try {
            ...
            // Token is now secured in HttpOnly Cookie (handled automatically by browser)
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white flex flex-col font-sans selection:bg-gold/30 relative overflow-hidden">
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    <div className="absolute inset-0 bg-black/60 z-10" /> {/* Overlay muy oscuro para legibilidad */}
            ...
            {/* Navbar / Header */}
            <header className="w-full max-w-7xl mx-auto p-6 flex items-center justify-between relative z-20">
                <div className="flex items-center gap-3 backdrop-blur-md bg-black/30 p-2 pr-4 rounded-full border border-white/5">
                    <img src="https://imgur.com/aZMcktO.png" alt="SpainRP Logo" className="w-8 h-8 rounded-full shadow-lg" />
                    <span className="font-bold text-lg tracking-tight">SpainRP<span className="text-gold">Awards</span></span>
                </div>
                <div className="bg-green-900/40 backdrop-blur border border-green-500/20 px-4 py-1.5 rounded-full flex items-center gap-2 text-green-400 text-xs font-bold uppercase tracking-wider">
            ...
            {/* Main Content */}
            <main className="flex-1 w-full max-w-7xl mx-auto p-6 flex flex-col lg:flex-row items-center justify-center gap-16 relative z-20">
                ...
                <div className="flex-1 space-y-10 max-w-2xl">
                    ...
                    >
                        ...
                        <p className="text-gray-300 text-xl lg:text-2xl max-w-lg leading-relaxed font-light border-l-4 border-gold pl-6">
                ...
                <div className="flex-1 w-full max-w-md perspective-1000">
                    <motion.div
                        ...
                        className="bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 shadow-2xl relative group"
                    >
                        {/* 3D Depth Elements */}
                        <div
                        ...
                        <div className="flex flex-col items-center text-center mb-10" style={{ transform: "translateZ(20px)" }}>
                            ...
                            <p className="text-gray-400 text-sm mt-2">Identifícate mediante credenciales seguras</p>
                        </div>
                        ...
                        <div style={{ transform: "translateZ(30px)" }}>
                            {loading ? (
                                ...
                                <div className="space-y-6">
                                    <a
                                        href={AUTH_URL}
                                        className="group relative block w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold py-4 rounded-xl shadow-lg shadow-indigo-500/20 transition-all overflow-hidden"
                                    >
